    ...
    if (projects.length === 0) {
        ...
        projectsGrid.innerHTML = projects.map(project => `
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 group relative">
                <button onclick="deleteProject('${project.id}'); event.stopPropagation();" class="absolute top-4 right-4 p-2 bg-red-50 hover:bg-red-100 rounded-lg transition-colors z-10" title="프로젝트 삭제">
