...
function renderProjects() {
    ...
    if (projects.length === 0) {
        ...
        projectsGrid.innerHTML = projects.map(project => `
            <div onclick="openPasswordModal('${project.id}')" class="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer group hover:-translate-y-1">
                <div class="p-6">
